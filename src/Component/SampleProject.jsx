...
const SampleProject = () => {
  ...
  return (
    <>
      ...
      <Button className=" flex shadow-lg items-center h-fit mx-24 ms-auto gap-2">
  <FaGithub className="  p-0  " /> {/* Adjusted size for better alignment */}
  <Link to="/projects" className="flex-grow text-center">
    View All Projects
  </Link>
