...
const SampleProject = () => {
  ...
  return (
      <><h1 className="text-black dark:text-white text-center text-3xl font-bold opacity-35 ">PROJECTS</h1><div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-8 md:px-24 relative">
      {items.map((item, index) => (
        ...
        >
                <img src={item.image} className=" hover:grayscale relative  object-cover  flex-shrink-0  h-[200px] rounded-lg " alt={item.title} />
          <motion.h2 className="text-2xl font-bold text-center">{item.title}</motion.h2>
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col justify-between  ">
                <CiCirclePlus className=' cursor-pointer text-2xl' onClick={() => setSelectedId(null)} />
