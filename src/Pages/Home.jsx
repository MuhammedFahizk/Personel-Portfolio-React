            ...
            <div className='md:w-1/2 flex justify-center items-center relative my-10'>
                <div className='relative grid justify-center items-center'>
                    <div 
                        ...
                        className="z-10 w-20 h-20  rounded-full blur-3xl p-14 shadow-lg absolute ms-14 md:ms-0 -top-4"
                    ></div>
                    ...
                    <div className="md:w-[300px] md:mx-0 mx-20 relative z-30">
                        <img 
                            className="rounded-3xl shadow-md md:rotate-12 sm:rotate-6 md:h-[400px]" 
                            src='https://images.pexels.com/photos/1043471/pexels-photo-1043471.jpeg?auto=compress&cs=tinysrgb&' 
                            alt="ses" 
                        />
                    </div>
